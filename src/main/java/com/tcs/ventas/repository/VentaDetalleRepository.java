...
public class VentaDetalleRepository {
	...
	public List<VentaDetalle> getVentaDetalleByIdVenta(int codigoVenta) {
		String sql = "SELECT t_venta_detalle.c_codigo_producto,t_venta_detalle.c_codigo_venta ,c_precio_unitario, c_cantidad, c_nombre_producto "
		...
		return jdbcTemplate.query(sql, (rs, rowNum) -> {
			...
			ventaDetalle.setCodigoVenta(rs.getInt("c_codigo_venta"));
